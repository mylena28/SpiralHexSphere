...
program main
    ...
    write(*,'(A,A)')    '  Cap method         : ', 'Zinchenko Level-1 icosahedral subdivision'
    write(*,'(A,I4)')   '  Cap new verts/cap  : ', num_sides + 1
    write(*,'(A,I4)')   '  Cap faces/cap      : ', 4 * num_sides
    write(*,'(A)') '------------------------------------------------------'
    ...
    call write_mesh(trim(outfile), total_nv, total_nf, nv_spiral, verts, faces)
